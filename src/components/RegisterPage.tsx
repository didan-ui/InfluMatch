...
import { saveDbUser, addDbLog, getDbUsers, hashPassword } from "../utils";
...
export default function RegisterPage({ onRegisterSuccess, onNavigateToLogin, onNavigateToWelcome }: RegisterPageProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await addDbLog(newUser.name, "Registrasi User", `${newUser.name} melakukan registrasi untuk tipe ${role.toUpperCase()}`, role);
